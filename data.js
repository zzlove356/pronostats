...
const MATCHES = [
{"id":"vasteras-sk-orgryte-2026-07-24","competition":{"fr":"Allsvenskan (Suède) – 14e journée","it":"Allsvenskan (Svezia) – 14ª giornata"},"date":{"fr":"vendredi 24 juillet 2026","it":"venerdì 24 luglio 2026"},"kickoff":{"fr":"19:00 (heure locale CEST)","it":"19:00 (ora locale CEST)"},"venue":"Hitachi Energy Arena / Iver Arena, Västerås (Suède)","home":{"name":{"fr":"Västerås SK","it":"Västerås SK"},"flag":"🔵"},"away":{"name":{"fr":"Örgryte IS","it":"Örgryte IS"},"flag":"🔴"},"odds":{"market":{"fr":"Résultat (1N2)","it":"Esito (1X2)"},"source":"sources publiques (Oddspedia, Bet-Experts, Ratingbet)","checkedAt":"23/07/2026","aiProb":{"home":50,"draw":26,"away":24},"best":{"home":{"dec":1.51,"frac":"51/100","book":"Oddspedia (consensus)"},"draw":{"dec":3.9,"frac":"29/10","book":"estimation marché"},"away":{"dec":5.5,"frac":"9/2","book":"estimation marché"}}},"safeBet":{"sel":{"fr":"Västerås SK - Plus de 1,5 but marqué par l'équipe","it":"Västerås SK - Over 1,5 gol segnati dalla squadra"},"dec":1.5,"frac":"1/2","book":"Granawin","ai":74,"why":{"fr":"⚠ Analyse en mode autonome (sources publiques), sans balayage oddschecker complet : cote indicative à revérifier chez ton bookmaker. Västerås a marqué au moins deux fois dans deux de ses trois derniers matchs à domicile, et le marché des buts totaux tourne autour de 3,46 buts/match sur les dernières confrontations des deux équipes.","it":"⚠ Analisi in modalità autonoma (fonti pubbliche), senza scansione completa di oddschecker: quota indicativa da riverificare presso il tuo bookmaker. Il Västerås ha segnato almeno due volte in due delle ultime tre gare casalinghe, con una media di 3,46 gol totali nelle recenti sfide delle due squadre."}},"simpleBet":{"sel":{"fr":"Västerås SK -1 (handicap asiatique, victoire par 2 buts d'écart ou plus)","it":"Västerås SK -1 (handicap asiatico, vittoria con 2 o più gol di scarto)"},"dec":1.82,"frac":"41/50","book":"marché handicap (agrégé)","ai":48,"why":{"fr":"⚠ Analyse en mode autonome (sources publiques), sans balayage oddschecker complet : cote indicative à revérifier chez ton bookmaker. Örgryte est 15e, a perdu ses cinq derniers déplacements et encaissé dans cinq de ses six derniers matchs, ce qui ouvre une vraie fenêtre pour un succès net des locaux.","it":"⚠ Analisi in modalità autonoma (fonti pubbliche), senza scansione completa di oddschecker: quota indicativa da riverificare presso il tuo bookmaker. L'Örgryte è 15° in classifica, ha perso le ultime cinque trasferte e ha subito gol in cinque delle ultime sei partite, aprendo una vera possibilità di successo netto per i padroni di casa."}},"markets":[{"category":{"fr":"Buts","it":"Gol"},"note":{"fr":"Les deux équipes affichent une moyenne de buts totaux élevée sur leurs derniers matchs.","it":"Entrambe le squadre mostrano una media gol totale elevata nelle ultime partite."},"rows":[{"sel":{"fr":"Plus de 2,5 buts","it":"Over 2,5 gol"},"dec":1.55,"frac":"11/20"},{"sel":{"fr":"BTTS Oui","it":"Entrambe segnano Sì"},"dec":1.75,"frac":"3/4"}]}],"valueBets":[{"label":{"fr":"Västerås Over 1,5 buts (équipe)","it":"Västerås Over 1,5 gol (squadra)"},"dec":1.5,"ai":74,"note":{"fr":"⚠ Analyse en mode autonome (sources publiques) : cote indicative à revérifier chez ton bookmaker.","it":"⚠ Analisi in modalità autonoma (fonti pubbliche): quota indicativa da riverificare presso il tuo bookmaker."}}],"prediction":{"pick":{"fr":"Victoire Västerås SK, match ouvert avec plusieurs buts","it":"Vittoria Västerås SK, partita aperta con diversi gol"},"pickShort":"1 & Over 2.5","score":"2 - 1","goals":{"fr":"Les deux équipes devraient trouver le chemin des filets, avec un avantage net pour les locaux en seconde période.","it":"Entrambe le squadre dovrebbero segnare, con un vantaggio netto per i padroni di casa nella ripresa."},"confidence":"moyen","value":true,"summary":{"fr":"Västerås SK, promu ambitieux 8e du classement, reçoit un Örgryte en méforme chronique à l'extérieur (5 défaites de suite loin de ses bases). Les locaux sont clairement favoris et pourraient l'emporter avec un certain confort. ⚠ Analyse en mode autonome (sources publiques), sans balayage oddschecker complet : cote indicative à revérifier chez ton bookmaker.","it":"Il Västerås SK, neopromossa ambiziosa e 8ª in classifica, ospita un Örgryte in crisi cronica in trasferta (5 sconfitte di fila lontano da casa). I padroni di casa sono chiaramente favoriti e potrebbero vincere con un certo margine. ⚠ Analisi in modalità autonoma (fonti pubbliche), senza scansione completa di oddschecker: quota indicativa da riverificare presso il tuo bookmaker."},"basedOn":{"fr":["Västerås SK a pris 7 points sur ses 3 derniers matchs depuis la reprise, en battant Halmstad et Degerfors","Örgryte a perdu ses cinq derniers déplacements et encaisse très régulièrement","Le marché fixe Västerås favori à 1.51/1.55"],"it":["Il Västerås SK ha raccolto 7 punti nelle ultime 3 gare dalla ripresa, battendo Halmstad e Degerfors","L'Örgryte ha perso le ultime cinque trasferte e subisce gol con grande regolarità","Il mercato indica il Västerås favorito a 1.51/1.55"]},"against":{"fr":["Le promu Västerås reste irrégulier (5V 4N 4D en 13 matchs), une contre-performance n'est pas exclue","H2H globalement équilibré sur les confrontations historiques (3-3-6 en Superettan)"],"it":["Il neopromosso Västerås resta irregolare (5V 4N 4D in 13 partite), una prestazione deludente non è esclusa","Precedenti storici globalmente equilibrati (3-3-6 in Superettan)"]}},"teams":{"home":{"name":{"fr":"Västerås SK","it":"Västerås SK"},"flag":"🔵","coach":"Alexander Rubin","lineup":{"fr":"1-5-4-1 probable : Jäger - Baggesen, Geffvert, Bonde, Magnusson, Wernersson - Taonsa, Lushaku, Diagne, Gunnarsson - Ladefoged","it":"1-5-4-1 probabile: Jäger - Baggesen, Geffvert, Bonde, Magnusson, Wernersson - Taonsa, Lushaku, Diagne, Gunnarsson - Ladefoged"},"style":{"fr":"Bloc à 5 en défense, transitions rapides via les couloirs, forte proportion de matchs avec buts des deux côtés (62%).","it":"Blocco a 5 in difesa, transizioni rapide sulle fasce, alta percentuale di partite con gol da entrambe le parti (62%)."},"absences":{"fr":["Aucune absence majeure confirmée dans les sources consultées"],"it":["Nessuna assenza rilevante confermata nelle fonti consultate"]},"physical":{"fr":"Effectif reposé après la reprise estivale, dynamique positive.","it":"Rosa riposata dopo la ripresa estiva, dinamica positiva."},"form":{"fr":"Västerås SK est huitième du championnat avec 19 points en 13 matchs (5V 4N 4D), en forme depuis la reprise de juillet avec des victoires contre Halmstad et Degerfors.","it":"Il Västerås SK è ottavo in classifica con 19 punti in 13 partite (5V 4N 4D), in buona forma dalla ripresa di luglio con vittorie contro Halmstad e Degerfors."},"xg":{"fr":"Non disponible dans les sources publiques consultées.","it":"Non disponibile nelle fonti pubbliche consultate."},"context":{"fr":"Club promu de Superettan, ambitionne de consolider sa place en Allsvenskan cette saison.","it":"Club neopromosso dalla Superettan, punta a consolidare la propria posizione in Allsvenskan questa stagione."},"source":"Sports Mole, Ratingbet, Bet-Experts"},"away":{"name":{"fr":"Örgryte IS","it":"Örgryte IS"},"flag":"🔴","coach":"—","lineup":{"fr":"1-5-3-2 / 3-4-3 probable : Gustafsson - Parker, Paulson, Stiffe, Azulay, Lagerlund - Parker-Price, Windehall, Hofwander - Sana, Kristoffersson","it":"1-5-3-2 / 3-4-3 probabile: Gustafsson - Parker, Paulson, Stiffe, Azulay, Lagerlund - Parker-Price, Windehall, Hofwander - Sana, Kristoffersson"},"style":{"fr":"Bloc bas, difficultés défensives à l'extérieur, tentatives de transitions rapides via Sana et Kristoffersson.","it":"Blocco basso, difficoltà difensive in trasferta, tentativi di transizione rapida tramite Sana e Kristoffersson."},"absences":{"fr":["Aucune absence confirmée précisément dans les sources consultées"],"it":["Nessuna assenza confermata con precisione nelle fonti consultate"]},"physical":{"fr":"Équipe fébrile à l'extérieur, série négative en déplacement.","it":"Squadra fragile in trasferta, serie negativa lontano da casa."},"form":{"fr":"Örgryte est 15e avec 10 points, a perdu ses cinq derniers matchs à l'extérieur et encaissé dans cinq de ses six dernières rencontres, notamment une défaite 0-3 à Kalmar.","it":"L'Örgryte è 15° con 10 punti, ha perso le ultime cinque trasferte e subito gol in cinque delle ultime sei partite, tra cui una sconfitta 0-3 a Kalmar."},"xg":{"fr":"Non disponible dans les sources publiques consultées.","it":"Non disponibile nelle fonti pubbliche consultate."},"context":{"fr":"Promu après 16 saisons d'absence de l'élite, l'objectif est le maintien.","it":"Promossa dopo 16 stagioni di assenza dall'elite, l'obiettivo è la salvezza."},"source":"Ratingbet, Freetips, Bet-Experts"}},"keyPlayers":[{"team":"🔵","name":"Karl Gunnarsson","pos":{"fr":"Milieu offensif / Attaquant","it":"Centrocampista offensivo / Attaccante"},"stat":{"fr":"Titulaire régulier dans le onze probable de Västerås","it":"Titolare abituale nell'undici probabile del Västerås"},"note":{"fr":"Élément clé de la ligne offensive locale ces dernières semaines.","it":"Elemento chiave della linea offensiva locale nelle ultime settimane."}},{"team":"🔴","name":"Tobias Sana","pos":{"fr":"Attaquant","it":"Attaccante"},"stat":{"fr":"Titulaire en pointe dans le onze probable d'Örgryte","it":"Titolare in attacco nell'undici probabile dell'Örgryte"},"note":{"fr":"Doit porter l'attaque d'une équipe en méforme à l'extérieur.","it":"Deve trascinare l'attacco di una squadra in crisi fuori casa."}}],"matchInfo":{"h2h":{"fr":"12 confrontations historiques (Allsvenskan/Superettan) : bilan équilibré 3 victoires Örgryte, 2 victoires Västerås SK, 6 nuls ; le dernier duel avait vu Västerås s'imposer 2-0.","it":"12 precedenti storici (Allsvenskan/Superettan): bilancio equilibrato 3 vittorie Örgryte, 2 vittorie Västerås SK, 6 pareggi; nell'ultimo confronto il Västerås ha vinto 2-0."},"referee":{"fr":"Arbitre non confirmé dans les sources publiques consultées.","it":"Arbitro non confermato nelle fonti pubbliche consultate."},"stake":{"fr":"Match de milieu de tableau pour Västerås, lutte pour le maintien pour Örgryte.","it":"Partita di metà classifica per il Västerås, lotta salvezza per l'Örgryte."},"external":{"fr":"Aucun élément externe majeur (météo, terrain) signalé.","it":"Nessun elemento esterno rilevante (meteo, terreno) segnalato."},"supercomputer":{"fr":"Non disponible dans les sources publiques consultées.","it":"Non disponibile nelle fonti pubbliche consultate."}},"sources":[{"label":"Ratingbet – Västerås vs Örgryte prediction","url":"https://ratingbet.com/predictions/vsters-vs-rgryte-prediction-expert-analysis-possible-lineups-july-24-2026/"},{"label":"Bet-Experts – Vasteras SK vs Orgryte prediction","url":"https://www.bet-experts.com/vasteras-sk-vs-orgryte-prediction-24072026/"},{"label":"Sports Mole – Preview Vasteras vs Orgryte","url":"https://www.sportsmole.co.uk/football/vasteras-sk/preview/vasteras-vs-orgryte-prediction-team-news-lineups_601667.html"},{"label":"Oddspedia – Vasteras SK vs Orgryte IS","url":"https://oddspedia.com/football/vasteras-sk-orgryte-is-110407"},{"label":"Freetips – Vasteras vs Orgryte","url":"https://www.freetips.com/football/vasteras-vs-orgryte-live-stream-20260722-0036/"}]},
{"id":"degerfors-djurgarden-2026-07-25","competition":{"fr":"Allsvenskan (Suède) – 14e journée","it":"Allsvenskan (Svezia) – 14ª giornata"},"date":{"fr":"samedi 25 juillet 2026 (aucun match dans les compétitions suivies le 24/07 hormis Västerås-Örgryte, ce match du lendemain est inclus comme 2e affiche la plus intéressante)","it":"sabato 25 luglio 2026 (nessuna partita nelle competizioni seguite il 24/07 a parte Västerås-Örgryte, questa gara del giorno dopo è inclusa come 2ª partita più interessante)"},"kickoff":{"fr":"15:00 (heure locale CEST)","it":"15:00 (ora locale CEST)"},"venue":"Stora Valla, Degerfors (Suède)","home":{"name":{"fr":"Degerfors IF","it":"Degerfors IF"},"flag":"🔵"},"away":{"name":{"fr":"Djurgårdens IF","it":"Djurgårdens IF"},"flag":"🔴"},"odds":{"market":{"fr":"Résultat (1N2)","it":"Esito (1X2)"},"source":"sources publiques (Ratingbet)","checkedAt":"23/07/2026","aiProb":{"home":18,"draw":22,"away":60},"best":{"home":{"dec":4.3,"frac":"33/10","book":"Linebet (agrégé)"},"draw":{"dec":3.8,"frac":"14/5","book":"Linebet (agrégé)"},"away":{"dec":1.75,"frac":"3/4","book":"Linebet (agrégé)"}}},"safeBet":{"sel":{"fr":"Double chance : Nul ou victoire Djurgårdens IF (X2)","it":"Doppia chance: Pareggio o vittoria Djurgårdens IF (X2)"},"dec":1.28,"frac":"7/25","book":"estimation marché (à partir des cotes 1N2 agrégées)","ai":82,"why":{"fr":"⚠ Analyse en mode autonome (sources publiques), sans balayage oddschecker complet : cote indicative à revérifier chez ton bookmaker. Djurgården est en pleine forme (7 points sur 3 matchs, 7 buts marqués, 2 encaissés) alors que Degerfors vient de subir sa plus lourde défaite de la saison contre Hammarby et reste diminué par les absences de Sundgren et Pikkarainen.","it":"⚠ Analisi in modalità autonoma (fonti pubbliche), senza scansione completa di oddschecker: quota indicativa da riverificare presso il tuo bookmaker. Il Djurgården è in gran forma (7 punti in 3 partite, 7 gol segnati, 2 subiti) mentre il Degerfors ha appena subito la sconfitta più pesante della stagione contro l'Hammarby ed è indebolito dalle assenze di Sundgren e Pikkarainen."}},"simpleBet":{"sel":{"fr":"Victoire Djurgårdens IF","it":"Vittoria Djurgårdens IF"},"dec":1.75,"frac":"3/4","book":"Linebet (agrégé)","ai":60,"why":{"fr":"⚠ Analyse en mode autonome (sources publiques), sans balayage oddschecker complet : cote indicative à revérifier chez ton bookmaker. Les visiteurs sont clairement plus stables, portés par Strømland Lien, Hegland et Oslund, et abordent ce match sur une dynamique ascendante depuis début juillet.","it":"⚠ Analisi in modalità autonoma (fonti pubbliche), senza scansione completa di oddschecker: quota indicativa da riverificare presso il tuo bookmaker. Gli ospiti sono nettamente più stabili, trascinati da Strømland Lien, Hegland e Oslund, e affrontano la gara con un trend positivo dall'inizio di luglio."}},"markets":[{"category":{"fr":"Buts","it":"Gol"},"note":{"fr":"Djurgården affiche une moyenne de 3,42 buts totaux par match sur sa série récente, Degerfors 2,69.","it":"Il Djurgården mostra una media di 3,42 gol totali a partita nella sua serie recente, il Degerfors 2,69."},"rows":[{"sel":{"fr":"Plus de 2,5 buts","it":"Over 2,5 gol"},"dec":1.9,"frac":"9/10"},{"sel":{"fr":"Djurgården Over 1,5 buts (équipe)","it":"Djurgården Over 1,5 gol (squadra)"},"dec":1.65,"frac":"13/20"}]}],"valueBets":[{"label":{"fr":"Djurgården Over 1,5 buts (équipe)","it":"Djurgården Over 1,5 gol (squadra)"},"dec":1.65,"ai":58,"note":{"fr":"⚠ Analyse en mode autonome (sources publiques) : cote indicative à revérifier chez ton bookmaker.","it":"⚠ Analisi in modalità autonoma (fonti pubbliche): quota indicativa da riverificare presso il tuo bookmaker."}}],"prediction":{"pick":{"fr":"Victoire nette de Djurgårdens IF","it":"Netta vittoria del Djurgårdens IF"},"pickShort":"2 & Over 1.5 (away)","score":"1 - 2","goals":{"fr":"Degerfors devrait marquer au moins une fois mais Djurgården, en pleine confiance offensive, devrait l'emporter.","it":"Il Degerfors dovrebbe segnare almeno una volta ma il Djurgården, in piena fiducia offensiva, dovrebbe prevalere."},"confidence":"élevé","value":true,"summary":{"fr":"Djurgårdens IF aborde ce déplacement à Degerfors sur une série de 7 points en 3 matchs et une attaque retrouvée, face à un Degerfors qui vient d'encaisser sa plus lourde défaite de la saison et joue sans deux titulaires. ⚠ Analyse en mode autonome (sources publiques), sans balayage oddschecker complet : cote indicative à revérifier chez ton bookmaker.","it":"Il Djurgårdens IF affronta questa trasferta a Degerfors con una serie di 7 punti in 3 partite e un attacco ritrovato, contro un Degerfors che ha appena subito la sconfitta più pesante della stagione e gioca senza due titolari. ⚠ Analisi in modalità autonoma (fonti pubbliche), senza scansione completa di oddschecker: quota indicativa da riverificare presso il tuo bookmaker."},"basedOn":{"fr":["Djurgården a pris 7 points sur ses 3 derniers matchs, marquant 7 buts et n'en encaissant que 2","Degerfors a subi sa plus lourde défaite de la saison lors de son dernier match et joue sans Sundgren (talon) et Pikkarainen (croisés)","Le marché fixe Djurgården largement favori (odds around 1.7-1.75)"],"it":["Il Djurgården ha raccolto 7 punti nelle ultime 3 partite, segnando 7 gol e subendone solo 2","Il Degerfors ha subito la sconfitta più pesante della stagione nell'ultima partita e gioca senza Sundgren (tallone) e Pikkarainen (crociati)","Il mercato indica il Djurgården ampiamente favorito (quote intorno a 1.7-1.75)"]},"against":{"fr":["Degerfors joue à domicile et lutte directement pour son maintien, motivation maximale","BTTS fréquent des deux côtés (54-58%), un but degerforsien est probable"],"it":["Il Degerfors gioca in casa e lotta direttamente per la salvezza, motivazione massima","BTTS frequente da entrambe le parti (54-58%), un gol del Degerfors è probabile"]}},"teams":{"home":{"name":{"fr":"Degerfors IF","it":"Degerfors IF"},"flag":"🔵","coach":"—","lineup":{"fr":"1-4-4-2 probable : Igonen - Diatar, Ulsson, Ulsson, Sundgren(?) - Barsum, Karlsson, Hussein, Netabay - Fritzson, Taranis","it":"1-4-4-2 probabile: Igonen - Diatar, Ulsson, Ulsson, Sundgren(?) - Barsum, Karlsson, Hussein, Netabay - Fritzson, Taranis"},"style":{"fr":"Bloc médian, dépend fortement de Taranis en pointe, ligne défensive fragilisée par les absences.","it":"Blocco medio, molto dipendente da Taranis in attacco, linea difensiva indebolita dalle assenze."},"absences":{"fr":["Daniel Sundgren (talon, absent)","Juhani Pikkarainen (ligaments croisés, absent longue durée)"],"it":["Daniel Sundgren (tallone, assente)","Juhani Pikkarainen (legamenti crociati, assente lungo termine)"]},"physical":{"fr":"Équipe fatiguée après une lourde défaite, moral bas.","it":"Squadra stanca dopo una pesante sconfitta, morale basso."},"form":{"fr":"Degerfors a perdu cinq de ses sept derniers matchs, avec une défaite marquant la plus lourde de la saison lors de la dernière sortie face à Hammarby.","it":"Il Degerfors ha perso cinque delle ultime sette partite, con una sconfitta che rappresenta la più pesante della stagione nell'ultima uscita contro l'Hammarby."},"xg":{"fr":"Non disponible dans les sources publiques consultées.","it":"Non disponibile nelle fonti pubbliche consultate."},"context":{"fr":"Devance Norrköping d'un point dans la course au maintien (13e place).","it":"Precede il Norrköping di un punto nella corsa salvezza (13° posto)."},"source":"Ratingbet, Sports Mole"},"away":{"name":{"fr":"Djurgårdens IF","it":"Djurgårdens IF"},"flag":"🔴","coach":"Jani Honkavaara","lineup":{"fr":"1-4-2-3-1 probable : Rinne - Une-Larsson, Tenho, Larsson, Johansson - Siltanen, Finndell - Hegland, Oslund, Fallenius - Strømland","it":"1-4-2-3-1 probabile: Rinne - Une-Larsson, Tenho, Larsson, Johansson - Siltanen, Finndell - Hegland, Oslund, Fallenius - Strømland"},"style":{"fr":"Bloc offensif structuré, transitions rapides via les ailiers, forte proportion de BTTS (58%).","it":"Blocco offensivo strutturato, transizioni rapide sugli esterni, alta percentuale di BTTS (58%)."},"absences":{"fr":["Aucune absence majeure confirmée dans les sources consultées"],"it":["Nessuna assenza rilevante confermata nelle fonti consultate"]},"physical":{"fr":"Groupe en pleine confiance après une série de bons résultats depuis début juillet.","it":"Gruppo in piena fiducia dopo una serie di buoni risultati dall'inizio di luglio."},"form":{"fr":"Djurgården a repris la compétition avec une victoire 4-2 à Häcken, puis un succès 3-0 contre Halmstad et un nul 0-0 à Örgryte, cumulant 7 points sur 3 matchs.","it":"Il Djurgården ha ripreso la competizione con una vittoria 4-2 contro l'Häcken, poi un successo 3-0 contro l'Halmstad e un pareggio 0-0 a Örgryte, totalizzando 7 punti in 3 partite."},"xg":{"fr":"Non disponible dans les sources publiques consultées.","it":"Non disponibile nelle fonti pubbliche consultate."},"context":{"fr":"5e du championnat, à égalité avec Malmö, à un point du top 4 et à 3 points de la place qualificative pour les coupes d'Europe.","it":"5° in classifica, a pari punti con il Malmö, a un punto dalla top 4 e a 3 punti dal posto qualificante per le coppe europee."},"source":"Sports Mole – Preview Degerfors vs Djurgardens"}},"keyPlayers":[{"team":"🔵","name":"Arman Taranis","pos":{"fr":"Attaquant","it":"Attaccante"},"stat":{"fr":"Seul attaquant du trio de pointe à avoir marqué plus d'un but cette saison","it":"Unico attaccante del tridente offensivo ad aver segnato più di un gol questa stagione"},"note":{"fr":"Doit porter offensivement une équipe fragilisée par les absences défensives.","it":"Deve trascinare offensivamente una squadra indebolita dalle assenze difensive."}},{"team":"🔴","name":"Kristian Strømland Lien","pos":{"fr":"Attaquant","it":"Attaccante"},"stat":{"fr":"Meilleur buteur de Djurgården avec 7 buts cette saison","it":"Miglior marcatore del Djurgården con 7 gol in questa stagione"},"note":{"fr":"Élément offensif clé de la belle série en cours des visiteurs.","it":"Elemento offensivo chiave dell'ottima serie in corso degli ospiti."}}],"matchInfo":{"h2h":{"fr":"Djurgården domine largement l'historique récent avec 8 victoires contre 4 pour Degerfors et 1 nul ; les deux derniers duels de la saison passée s'étaient soldés par un nul et une victoire de Djurgården.","it":"Il Djurgården domina ampiamente lo storico recente con 8 vittorie contro 4 del Degerfors e 1 pareggio; gli ultimi due confronti della stagione scorsa si erano conclusi con un pareggio e una vittoria del Djurgården."},"referee":{"fr":"Arbitre non confirmé dans les sources publiques consultées.","it":"Arbitro non confermato nelle fonti pubbliche consultate."},"stake":{"fr":"Enjeu maintien pour Degerfors, course à l'Europe pour Djurgården.","it":"Posta salvezza per il Degerfors, corsa all'Europa per il Djurgården."},"external":{"fr":"Aucun élément externe majeur signalé.","it":"Nessun elemento esterno rilevante segnalato."},"supercomputer":{"fr":"Non disponible dans les sources publiques consultées.","it":"Non disponibile nelle fonti pubbliche consultate."}},"sources":[{"label":"Ratingbet – Degerfors vs Djurgården prediction","url":"https://ratingbet.com/predictions/degerfors-vs-djurgrden-prediction-expert-analysis-possible-lineups-july-25-2026/"},{"label":"Sports Mole – Preview Degerfors vs Djurgardens","url":"https://www.sportsmole.co.uk/football/degerfors/preview/degerfors-vs-djurgarden-prediction-team-news-lineups_601739.html"},{"label":"BettingExpert – Degerfors vs Djurgaarden","url":"https://www.bettingexpert.com/football/degerfors-vs-djurgaarden"}]},

{"id":"hammarby-anderlecht-2026-07-23","competition":{"fr":"Ligue Europa – 2e tour de qualification (match aller)","it":"Europa League – 2° turno di qualificazione (andata)"},"date":{"fr":"Jeudi 23 juillet 2026","it":"Giovedì 23 luglio 2026"},"kickoff":{"fr":"19h00 (heure locale de Stockholm)","it":"Ore 19:00 (ora locale di Stoccolma)"},"venue":"Tele2 Arena (3Arena), Stockholm, Suède","home":{"name":{"fr":"Hammarby IF","it":"Hammarby IF"},"flag":"🔵"},"away":{"name":{"fr":"RSC Anderlecht","it":"RSC Anderlecht"},"flag":"🔴"},"odds":{"market":{"fr":"Résultat (1N2)","it":"Esito (1X2)"},"source":"sources publiques (aperçus prono, non un book unique)","checkedAt":"23/07/2026","aiProb":{"home":36,"draw":27,"away":37},"best":{"home":{"dec":2.6,"frac":"8/5","book":"agrégateur public"},"draw":{"dec":3.4,"frac":"12/5","book":"agrégateur public"},"away":{"dec":2.82,"frac":"9/5","book":"agrégateur public (cité par un prévisionniste)"}}},"safeBet":{"sel":{"fr":"Double chance Hammarby ou nul (1X)","it":"Doppia chance Hammarby o pareggio (1X)"},"dec":1.6,"frac":"3/5","book":"agrégateur public","ai":63,"why":{"fr":"Hammarby enchaîne 3 victoires de suite (dont un 4-0) sous son nouveau coach Rydström, à domicile, face à un Anderlecht qui n'a plus joué de match officiel depuis fin mai et change aussi d'entraîneur. ⚠ Analyse en mode autonome (sources publiques), sans balayage oddschecker complet : cote indicative à revérifier chez ton bookmaker.","it":"L'Hammarby infila 3 vittorie di fila (incluso un 4-0) col nuovo tecnico Rydström, in casa, contro un Anderlecht senza gare ufficiali da fine maggio e anch'esso con un nuovo allenatore. ⚠ Analisi in modalità autonoma (fonti pubbliche), senza scansione completa oddschecker: quota indicativa da riverificare presso il tuo bookmaker."}},"simpleBet":{"sel":{"fr":"Plus de 2,5 buts dans le match","it":"Over 2,5 gol nella partita"},"dec":1.85,"frac":"17/20","book":"agrégateur public","ai":58,"why":{"fr":"Hammarby marque beaucoup en ce moment (4-0 lors du dernier match) et Anderlecht affiche des soucis défensifs selon plusieurs prévisionnistes ; un premier match aller de qualif' européenne avec deux attaques motivées peut vite s'ouvrir. ⚠ Analyse en mode autonome (sources publiques), sans balayage oddschecker complet : cote indicative à revérifier chez ton bookmaker.","it":"L'Hammarby segna molto in questo momento (4-0 nell'ultima gara) e l'Anderlecht mostra problemi difensivi secondo diversi pronosticatori; una gara di andata di qualificazione europea con due attacchi motivati può aprirsi rapidamente. ⚠ Analisi in modalità autonoma (fonti pubbliche), senza scansione completa oddschecker: quota indicativa da riverificare presso il tuo bookmaker."}},"markets":[{"category":{"fr":"Double chance","it":"Doppia chance"},"note":{"fr":"Le format de qualification aller-retour incite à la prudence ; Hammarby n'a jamais affronté Anderlecht.","it":"Il format di qualificazione andata-ritorno invita alla prudenza; l'Hammarby non ha mai affrontato l'Anderlecht."},"rows":[{"sel":{"fr":"1X (Hammarby ou nul)","it":"1X (Hammarby o pareggio)"},"dec":1.6,"frac":"3/5"},{"sel":{"fr":"X2 (nul ou Anderlecht)","it":"X2 (pareggio o Anderlecht)"},"dec":1.42,"frac":"21/50"}]},{"category":{"fr":"Buts","it":"Gol"},"note":{"fr":"Forme offensive d'Hammarby (4-0 au dernier match) et fragilité défensive prêtée à Anderlecht.","it":"Buona forma offensiva dell'Hammarby (4-0 nell'ultima gara) e fragilità difensiva attribuita all'Anderlecht."},"rows":[{"sel":{"fr":"Plus de 2,5 buts","it":"Over 2,5 gol"},"dec":1.85,"frac":"17/20"},{"sel":{"fr":"Les deux équipes marquent - Oui","it":"Entrambe le squadre segnano - Sì"},"dec":1.67,"frac":"4/6"}]}],"valueBets":[{"label":{"fr":"Les deux équipes marquent - Oui","it":"Entrambe le squadre segnano - Sì"},"dec":1.67,"ai":57,"note":{"fr":"Coté 4/6 selon un prévisionniste spécialisé ; cohérent avec les soucis défensifs prêtés à Anderlecht face à une équipe suédoise en pleine confiance.","it":"Quotato 4/6 secondo un pronosticatore specializzato; coerente con i problemi difensivi attribuiti all'Anderlecht contro una squadra svedese in piena fiducia."}}],"prediction":{"pick":{"fr":"Hammarby, portée par sa dynamique et son public, résiste voire s'impose face à un Anderlecht pas encore rodé","it":"L'Hammarby, spinto dalla dinamica e dal pubblico, resiste o addirittura si impone contro un Anderlecht non ancora rodato"},"pickShort":"1X + Over 2.5","score":"2 - 1","goals":{"fr":"Un match ouvert avec buts des deux côtés attendu, avantage Hammarby dans le rythme de forme","it":"Una partita aperta con gol attesi da entrambe le parti, vantaggio Hammarby nel ritmo di forma"},"confidence":"moyen","value":true,"summary":{"fr":"Hammarby aborde ce match aller avec 3 victoires de suite sous son nouveau coach, quand Anderlecht n'a plus disputé de match officiel depuis fin mai et doit composer avec les absences de Sardella et les doutes sur son gardien De Cat. Anderlecht reste toutefois considéré comme légèrement favori par certains books (cote 2,82). ⚠ Analyse en mode autonome (sources publiques), sans balayage oddschecker complet : cote indicative à revérifier chez ton bookmaker.","it":"L'Hammarby affronta questa andata con 3 vittorie consecutive sotto il nuovo tecnico, mentre l'Anderlecht non gioca una gara ufficiale da fine maggio e deve fare i conti con le assenze di Sardella e i dubbi sul portiere De Cat. L'Anderlecht resta comunque leggermente favorito secondo alcuni book (quota 2,82). ⚠ Analisi in modalità autonoma (fonti pubbliche), senza scansione completa oddschecker: quota indicativa da riverificare presso il tuo bookmaker."},"basedOn":{"fr":["3 victoires de suite pour Hammarby dont un 4-0 récent","Anderlecht sans match officiel depuis fin mai, nouveau coach Vítor Bruno","Absences notables côté Anderlecht (Sardella, doute sur De Cat)"],"it":["3 vittorie di fila per l'Hammarby incluso un recente 4-0","Anderlecht senza gare ufficiali da fine maggio, nuovo tecnico Vítor Bruno","Assenze rilevanti lato Anderlecht (Sardella, dubbio su De Cat)"]},"against":{"fr":["Anderlecht conserve une profondeur d'effectif supérieure et reste favori des bookmakers (2,82)","Aucun historique H2H pour calibrer l'écart réel","Hammarby traverse une transition d'entraîneur qui peut manquer de continuité"],"it":["L'Anderlecht mantiene una rosa più profonda e resta favorito dai bookmaker (2,82)","Nessun precedente H2H per calibrare il reale divario","L'Hammarby attraversa una transizione di allenatore che può mancare di continuità"]}},"teams":{"home":{"name":{"fr":"Hammarby IF","it":"Hammarby IF"},"flag":"🔵","coach":"Henrik Rydström","lineup":{"fr":"4-3-3 probable avec Besara en meneur de jeu et Abraham en pointe","it":"4-3-3 probabile con Besara trequartista e Abraham punta"},"style":{"fr":"Bloc offensif, transitions rapides, forte possession (58% en moyenne récente)","it":"Blocco offensivo, transizioni rapide, forte possesso (58% in media recente)"},"absences":{"fr":["Suru Kone (genou)","Amin Boudri (enregistrement administratif non finalisé, titularisation improbable)"],"it":["Suru Kone (ginocchio)","Amin Boudri (registrazione amministrativa non finalizzata, titolarità improbabile)"]},"physical":{"fr":"Effectif au complet ou presque, dynamique physique positive après 3 victoires","it":"Rosa quasi al completo, dinamica fisica positiva dopo 3 vittorie"},"form":{"fr":"Hammarby a enchaîné les victoires face à Elfsborg (2-1), Kalmar (2-0) et Degerfors (4-0)","it":"L'Hammarby ha incatenato vittorie contro Elfsborg (2-1), Kalmar (2-0) e Degerfors (4-0)"},"xg":{"fr":"Non communiqué publiquement pour ce match précis","it":"Non comunicato pubblicamente per questa gara specifica"},"context":{"fr":"Bajen dispute son 4e tour de qualification Europa League et a déjà éliminé Charleroi en Conference League la saison passée, preuve qu'il sait gérer les clubs belges","it":"L'Hammarby disputa la sua 4ª partecipazione alle qualificazioni di Europa League e la scorsa stagione ha già eliminato il Charleroi in Conference League, prova che sa gestire i club belgi"},"source":"dailysports.net, sportsgambler.com, toffeeweb.com"},"away":{"name":{"fr":"RSC Anderlecht","it":"RSC Anderlecht"},"flag":"🔴","coach":"Vítor Bruno","lineup":{"fr":"Possible titularisation de jeunes recrues (Ambros, Cvetkovic en pointe) faute de rythme de compétition","it":"Possibile titolarità di giovani rinforzi (Ambros, Cvetkovic punta) per mancanza di ritmo agonistico"},"style":{"fr":"Style en reconstruction sous le nouveau coach portugais, ex-adjoint à Porto","it":"Stile in ricostruzione sotto il nuovo tecnico portoghese, ex assistente al Porto"},"absences":{"fr":["Killian Sardella (quadriceps, opéré)","Nathan De Cat, gardien, doute (blessure abdominale)"],"it":["Killian Sardella (quadricipite, operato)","Nathan De Cat, portiere, in dubbio (infortunio addominale)"]},"physical":{"fr":"Manque de rythme compétitif : dernier match officiel fin mai, seulement pré-saison depuis","it":"Mancanza di ritmo competitivo: ultima gara ufficiale fine maggio, solo amichevoli da allora"},"form":{"fr":"Aucun match officiel depuis la défaite 1-5 contre l'Union Saint-Gilloise fin mai ; un succès et un nul en pré-saison","it":"Nessuna gara ufficiale dalla sconfitta 1-5 contro l'Union Saint-Gilloise di fine maggio; una vittoria e un pareggio in pre-stagione"},"xg":{"fr":"Non communiqué publiquement pour ce match précis","it":"Non comunicato pubblicamente per questa gara specifica"},"context":{"fr":"Perte de Thorgan Hazard (parti à Lens) qui reporte la charge offensive sur le jeune Cvetkovic","it":"Perdita di Thorgan Hazard (partito al Lens) che scarica il peso offensivo sul giovane Cvetkovic"},"source":"footballwhispers.com, dhnet.be, toffeeweb.com"}},"keyPlayers":[{"team":"🔵","name":"Nahir Besara","pos":{"fr":"Milieu offensif / capitaine","it":"Centrocampista offensivo / capitano"},"stat":{"fr":"128 matchs de championnat disputés pour Hammarby","it":"128 partite di campionato disputate con l'Hammarby"},"note":{"fr":"Leader technique et d'expérience du secteur offensif suédois","it":"Leader tecnico e d'esperienza del reparto offensivo svedese"}},{"team":"🔴","name":"Mihajlo Cvetković","pos":{"fr":"Attaquant","it":"Attaccante"},"stat":{"fr":"10 buts en 35 matchs la saison passée","it":"10 gol in 35 partite la scorsa stagione"},"note":{"fr":"Doit prendre le relais offensif après le départ de Hazard","it":"Deve prendere il testimone offensivo dopo la partenza di Hazard"}}],"matchInfo":{"h2h":{"fr":"Aucune confrontation officielle recensée entre les deux clubs avant ce match","it":"Nessun precedente ufficiale registrato tra i due club prima di questa gara"},"referee":{"fr":"Non communiqué à ce jour dans les sources publiques consultées","it":"Non comunicato ad oggi nelle fonti pubbliche consultate"},"stake":{"fr":"Match aller du 2e tour de qualification Europa League, retour prévu le 30 juillet à Bruxelles","it":"Andata del 2° turno di qualificazione Europa League, ritorno previsto il 30 luglio a Bruxelles"},"external":{"fr":"Aucune donnée météo officielle trouvée pour Stockholm ce jour-là","it":"Nessun dato meteo ufficiale trovato per Stoccolma in quella data"},"supercomputer":{"fr":"Aucun modèle de super-ordinateur public identifié pour ce match","it":"Nessun modello di supercomputer pubblico individuato per questa gara"}},"sources":[{"label":"Livefoot - heure et compositions","url":"https://www.livefoot.fr/direct/ligue-europa-europe/match-hammarby-vs-anderlecht-3e48cc69"},{"label":"DH Les Sports+ - compositions probables","url":"https://www.dhnet.be/sports/football/division-1a/anderlecht/2026/07/23/un-gamin-de-17-ans-et-nathan-saliba-titulaires-cest-possible-voici-les-compositions-probables-de-hammarby-anderlecht-GQNQH7PZMZGZXLNTYUU7YRF7DM/"},{"label":"Football Whispers - preview & betting tips","url":"https://footballwhispers.com/blog/hammarby-vs-anderlecht-prediction-23-07-2026/"},{"label":"Dailysports - prediction & team news","url":"https://dailysports.net/predictions/is-belgian-class-enough-prediction-for-the-hammarby-vs-anderlecht-match-23072026/"},{"label":"Toffeeweb - predictions, picks & odds","url":"https://www.toffeeweb.com/ng/hammarby-vs-anderlecht-predictions-picks-odds-23-07-2026/"},{"label":"Playmakerstats - stats & lineups","url":"https://www.playmakerstats.com/match/2026-07-23-hammarby-anderlecht/12249804"}]},
{"id":"alashkert-cfr-cluj-2026-07-23","competition":{"fr":"Ligue Europa Conférence – 2e tour de qualification (match aller)","it":"UEFA Conference League – 2° turno di qualificazione (andata)"},"date":{"fr":"Jeudi 23 juillet 2026","it":"Giovedì 23 luglio 2026"},"kickoff":{"fr":"19h00 heure locale (15h00 UTC), Erevan","it":"Ore 19:00 locali (15:00 UTC), Erevan"},"venue":"Alashkert Stadium, Erevan, Arménie","home":{"name":{"fr":"FC Alashkert","it":"FC Alashkert"},"flag":"🔵"},"away":{"name":{"fr":"CFR 1907 Cluj","it":"CFR 1907 Cluj"},"flag":"🔴"},"odds":{"market":{"fr":"Résultat (1N2)","it":"Esito (1X2)"},"source":"sources publiques (aucun comparateur complet trouvé pour ce match, cotes estimées à partir des aperçus)","checkedAt":"23/07/2026","aiProb":{"home":20,"draw":24,"away":56},"best":{"home":{"dec":4.5,"frac":"7/2","book":"estimation interne"},"draw":{"dec":3.6,"frac":"13/5","book":"estimation interne"},"away":{"dec":1.85,"frac":"17/20","book":"estimation interne"}}},"safeBet":{"sel":{"fr":"Double chance nul ou CFR Cluj (X2)","it":"Doppia chance pareggio o CFR Cluj (X2)"},"dec":1.3,"frac":"3/10","book":"estimation interne","ai":80,"why":{"fr":"CFR Cluj est considéré comme l'un des favoris de cette confrontation grâce à son expérience européenne récurrente, face à un Alashkert modeste (4e du championnat arménien) qui n'a validé son tour précédent qu'aux tirs au but. ⚠ Analyse en mode autonome (sources publiques), sans balayage oddschecker complet : cote indicative à revérifier chez ton bookmaker.","it":"Il CFR Cluj è considerato uno dei favoriti di questo confronto grazie alla sua esperienza europea ricorrente, contro un Alashkert modesto (4° nel campionato armeno) che ha superato il turno precedente solo ai rigori. ⚠ Analisi in modalità autonoma (fonti pubbliche), senza scansione completa oddschecker: quota indicativa da riverificare presso il tuo bookmaker."}},"simpleBet":{"sel":{"fr":"Victoire de CFR Cluj (2)","it":"Vittoria del CFR Cluj (2)"},"dec":1.85,"frac":"17/20","book":"estimation interne","ai":56,"why":{"fr":"Malgré une entame de saison ratée en championnat roumain (défaite à Otelul), CFR Cluj possède un effectif plus expérimenté que celui d'Alashkert, qui a dû batailler aux tirs au but pour passer le tour précédent contre un adversaire kazakh modeste. ⚠ Analyse en mode autonome (sources publiques), sans balayage oddschecker complet : cote indicative à revérifier chez ton bookmaker.","it":"Nonostante un inizio di stagione fallimentare in campionato rumeno (sconfitta a Otelul), il CFR Cluj ha una rosa più esperta di quella dell'Alashkert, che ha dovuto lottare ai rigori per superare il turno precedente contro un avversario kazako modesto. ⚠ Analisi in modalità autonoma (fonti pubbliche), senza scansione completa oddschecker: quota indicativa da riverificare presso il tuo bookmaker."}},"markets":[{"category":{"fr":"Double chance","it":"Doppia chance"},"note":{"fr":"L'écart de standing favorise largement les scénarios incluant CFR Cluj","it":"Il divario di livello favorisce ampiamente gli scenari che includono il CFR Cluj"},"rows":[{"sel":{"fr":"X2 (nul ou CFR Cluj)","it":"X2 (pareggio o CFR Cluj)"},"dec":1.3,"frac":"3/10"},{"sel":{"fr":"1X (Alashkert ou nul)","it":"1X (Alashkert o pareggio)"},"dec":2.05,"frac":"21/20"}]},{"category":{"fr":"Résultat","it":"Esito"},"note":{"fr":"Alashkert a déjà montré sa capacité à créer la surprise à domicile lors du tour précédent","it":"L'Alashkert ha già mostrato la capacità di creare sorprese in casa nel turno precedente"},"rows":[{"sel":{"fr":"Victoire CFR Cluj","it":"Vittoria CFR Cluj"},"dec":1.85,"frac":"17/20"},{"sel":{"fr":"Nul","it":"Pareggio"},"dec":3.6,"frac":"13/5"}]}],"valueBets":[{"label":{"fr":"Victoire CFR Cluj","it":"Vittoria CFR Cluj"},"dec":1.85,"ai":56,"note":{"fr":"CFR Cluj reste dans le sillage des équipes régulières des qualifications européennes malgré des éliminations en barrages les deux saisons passées, un statut d'expérience qui pèse face à un promu surprise arménien.","it":"Il CFR Cluj resta tra le squadre abituali delle qualificazioni europee nonostante le eliminazioni ai playoff nelle ultime due stagioni, uno status di esperienza che pesa contro una sorpresa armena."}}],"prediction":{"pick":{"fr":"CFR Cluj s'appuie sur son expérience européenne pour prendre un avantage à l'aller","it":"Il CFR Cluj sfrutta la propria esperienza europea per prendere un vantaggio all'andata"},"pickShort":"X2 + Victoire CFR Cluj","score":"0 - 2","goals":{"fr":"Match cadenassé attendu, Alashkert devra s'appuyer sur le contre et le soutien du public d'Erevan","it":"Partita bloccata attesa, l'Alashkert dovrà affidarsi al contropiede e al sostegno del pubblico di Erevan"},"confidence":"moyen","value":true,"summary":{"fr":"CFR Cluj, plus expérimenté sur la scène européenne (habitué des tours de qualification C1/C3/C4 ces dernières années), affronte un Alashkert auteur d'un parcours à suspense (qualification aux tirs au but face à Yelimay). Le nouveau coach roumain Antonio Folha découvre sa première campagne européenne à la tête du club. ⚠ Analyse en mode autonome (sources publiques), sans balayage oddschecker complet : cote indicative à revérifier chez ton bookmaker.","it":"Il CFR Cluj, più esperto sulla scena europea (abituato ai turni di qualificazione Champions/Europa/Conference negli ultimi anni), affronta un Alashkert reduce da un percorso ricco di suspense (qualificazione ai rigori contro il Yelimay). Il nuovo tecnico rumeno Antonio Folha vive la sua prima campagna europea alla guida del club. ⚠ Analisi in modalità autonoma (fonti pubbliche), senza scansione completa oddschecker: quota indicativa da riverificare presso il tuo bookmaker."},"basedOn":{"fr":["CFR Cluj plus expérimenté sur la scène européenne, plusieurs campagnes récentes en C1/C3/C4","Alashkert a eu besoin des tirs au but pour passer le tour précédent face à un adversaire modeste","CFR Cluj considéré comme favori par plusieurs prévisionnistes"],"it":["CFR Cluj più esperto sulla scena europea, diverse campagne recenti in Champions/Europa/Conference","L'Alashkert ha avuto bisogno dei rigori per superare il turno precedente contro un avversario modesto","Il CFR Cluj è considerato favorito da diversi pronosticatori"]},"against":{"fr":["CFR Cluj a débuté sa saison de championnat par une défaite (2-1 à Otelul)","Nouveau coach CFR Cluj (Antonio Folha) encore en phase de rodage tactique","Alashkert bénéficie du soutien du public d'Erevan et a déjà su créer des upsets"],"it":["Il CFR Cluj ha iniziato la stagione di campionato con una sconfitta (2-1 a Otelul)","Nuovo tecnico del CFR Cluj (Antonio Folha) ancora in fase di rodaggio tattico","L'Alashkert beneficia del sostegno del pubblico di Erevan e ha già saputo creare sorprese"]}},"teams":{"home":{"name":{"fr":"FC Alashkert","it":"FC Alashkert"},"flag":"🔵","coach":"Vahe Gevorgyan","lineup":{"fr":"Peu de changements attendus après la qualification aux tirs au but, Domi Jaures Massoumou pourrait entrer dans le onze","it":"Pochi cambi attesi dopo la qualificazione ai rigori, Domi Jaures Massoumou potrebbe entrare nell'undici titolare"},"style":{"fr":"Équipe qui devrait défendre bas et chercher le contre, comme lors du tour précédent","it":"Squadra che dovrebbe difendere basso e cercare il contropiede, come nel turno precedente"},"absences":{"fr":["Aucune absence confirmée publiquement à ce jour"],"it":["Nessuna assenza confermata pubblicamente ad oggi"]},"physical":{"fr":"Tour précédent disputé en prolongation et tirs au but, fatigue potentielle à surveiller","it":"Turno precedente giocato ai supplementari e ai rigori, potenziale stanchezza da monitorare"},"form":{"fr":"Qualifié de justesse (3-3 sur l'ensemble des deux matchs, 8-7 aux tirs au but) face au kazakh Yelimay","it":"Qualificato di misura (3-3 nel doppio confronto, 8-7 ai rigori) contro il kazako Yelimay"},"xg":{"fr":"Non communiqué publiquement","it":"Non comunicato pubblicamente"},"context":{"fr":"Seulement une 2e participation européenne de l'histoire du club, après 2021-22","it":"Solo una 2ª partecipazione europea nella storia del club, dopo il 2021-22"},"source":"sportsmole.co.uk, dailysports.net"},"away":{"name":{"fr":"CFR 1907 Cluj","it":"CFR 1907 Cluj"},"flag":"🔴","coach":"Antonio Folha","lineup":{"fr":"Effectif large avec des habitués des qualifications européennes","it":"Rosa ampia con giocatori abituati alle qualificazioni europee"},"style":{"fr":"Équipe expérimentée en Europe, cherchera à contrôler le jeu et à ne pas subir le contexte hostile d'Erevan","it":"Squadra esperta in Europa, cercherà di controllare il gioco e non subire il contesto ostile di Erevan"},"absences":{"fr":["Aucune absence confirmée publiquement à ce jour"],"it":["Nessuna assenza confermata pubblicamente ad oggi"]},"physical":{"fr":"Reprise de compétition récente, entame de championnat perdue (2-1 à Otelul)","it":"Ripresa agonistica recente, inizio di campionato perso (2-1 a Otelul)"},"form":{"fr":"3e du championnat roumain la saison passée, défaite 2-1 lors de la 1ère journée 2026-27 face à Otelul","it":"3° nel campionato rumeno la scorsa stagione, sconfitto 2-1 alla 1ª giornata 2026-27 contro l'Otelul"},"xg":{"fr":"Non communiqué publiquement","it":"Non comunicato pubblicamente"},"context":{"fr":"Éliminé aux barrages de Conference League les deux saisons précédentes (face à Pafos puis BK Häcken), avait atteint les 32e de finale en 2022-23","it":"Eliminato ai playoff di Conference League nelle ultime due stagioni (contro Pafos e poi BK Häcken), aveva raggiunto i 32esimi nel 2022-23"},"source":"sportsmole.co.uk, dailysports.net"}},"keyPlayers":[{"team":"🔵","name":"Davit Terteryan","pos":{"fr":"Milieu / attaquant","it":"Centrocampista / attaccante"},"stat":{"fr":"1 but en 2 matchs de qualification européenne cette saison","it":"1 gol in 2 partite di qualificazione europea in questa stagione"},"note":{"fr":"Élément offensif à surveiller sur les transitions rapides d'Alashkert","it":"Elemento offensivo da tenere d'occhio nelle transizioni rapide dell'Alashkert"}},{"team":"🔴","name":"Alin Fică","pos":{"fr":"Attaquant","it":"Attaccante"},"stat":{"fr":"Statistiques précises non communiquées publiquement pour ce début de saison","it":"Statistiche precise non comunicate pubblicamente per questo inizio di stagione"},"note":{"fr":"Attendu comme référence offensive de CFR Cluj pour ce tour de qualification","it":"Atteso come riferimento offensivo del CFR Cluj per questo turno di qualificazione"}}],"matchInfo":{"h2h":{"fr":"Les deux clubs se sont déjà affrontés en 2018 en qualifications de Ligue Europa, CFR Cluj s'étant imposé deux fois (2-0 et 5-0)","it":"I due club si sono già affrontati nel 2018 nelle qualificazioni di Europa League, con il CFR Cluj vincitore in entrambe le occasioni (2-0 e 5-0)"},"referee":{"fr":"Non communiqué à ce jour dans les sources publiques consultées","it":"Non comunicato ad oggi nelle fonti pubbliche consultate"},"stake":{"fr":"Match aller du 2e tour de qualification Conference League ; le vainqueur du cumul rejoint le 3e tour de qualification","it":"Andata del 2° turno di qualificazione Conference League; il vincitore del doppio confronto accede al 3° turno di qualificazione"},"external":{"fr":"Aucune donnée météo officielle trouvée pour Erevan ce jour-là","it":"Nessun dato meteo ufficiale trovato per Erevan in quella data"},"supercomputer":{"fr":"Aucun modèle de super-ordinateur public identifié pour ce match","it":"Nessun modello di supercomputer pubblico individuato per questa gara"}},"sources":[{"label":"Sports Mole - preview, team news, lineups","url":"https://www.sportsmole.co.uk/football/alashkert-fc/europa-conference-league/preview/alashkert-vs-cfr-cluj-prediction-team-news-lineups_601593.html"},{"label":"Dailysports - prediction & betting tips","url":"https://dailysports.net/predictions/prediction-for-the-alashkert-vs-cfr-cluj-match-will-the-armenian-club-have-enough-strength-for-another-sensation-23072026/"},{"label":"UEFA.com - compositions/effectifs Alashkert vs CFR Cluj","url":"https://www.uefa.com/uefaconferenceleague/match/2048852--alashkert-vs-cfr-cluj/lineups/"},{"label":"Sofascore - infos match, H2H","url":"https://www.sofascore.com/football/match/fc-alashkert-cfr-1907-cluj/MfcsqjC#id:16357227"},{"label":"beIN Sports - infos match","url":"https://www.beinsports.com/en-au/football/uefa-conference-league/alashkert-vs-cfr-cluj-2026-07-23"}]},

{"id":"levski-sofia-craiova-2026-07-22","competition":{"fr":"Ligue des Champions – 2e tour de qualification (aller)","it":"Champions League – 2° turno di qualificazione (andata)"},"date":{"fr":"22 juillet 2026","it":"22 luglio 2026"},"kickoff":{"fr":"20:30 (heure locale Sofia)","it":"20:30 (ora locale Sofia)"},"venue":"Vivacom Arena Georgi Asparuhov, Sofia","home":{"name":{"fr":"Levski Sofia","it":"Levski Sofia"},"flag":"🔵"},"away":{"name":{"fr":"Universitatea Craiova","it":"Universitatea Craiova"},"flag":"🔴"},"odds":{"market":{"fr":"Résultat (1N2)","it":"Esito (1X2)"},"source":"sources publiques","checkedAt":"22/07/2026","aiProb":{"home":45,"draw":28,"away":27},"best":{"home":{"dec":1.95,"frac":"19/20","book":"Tonybet/Oddslot"},"draw":{"dec":3.3,"frac":"23/10","book":"Tonybet/Oddslot"},"away":{"dec":3.8,"frac":"14/5","book":"1xbet"}}},"safeBet":{"sel":{"fr":"Double chance 1X (Levski ou match nul)","it":"Doppia chance 1X (Levski o pareggio)"},"dec":1.35,"frac":"7/20","book":"agrégateur cotes publiques","ai":74,"why":{"fr":"Les deux équipes sont invaincues et très proches statistiquement, mais Levski joue à domicile avec un avantage net dans le money-line et une bonne dynamique récente. ⚠ Analyse en mode autonome (sources publiques), sans balayage oddschecker complet : cote indicative à revérifier chez ton bookmaker.","it":"Entrambe le squadre sono imbattute e molto vicine a livello statistico, ma il Levski gioca in casa con un netto vantaggio nel money-line e una buona dinamica recente. ⚠ Analisi in modalità autonoma (fonti pubbliche), senza scansione completa oddschecker: quota indicativa da riverificare presso il tuo bookmaker."}},"simpleBet":{"sel":{"fr":"Moins de 2.5 buts","it":"Under 2.5 gol"},"dec":1.85,"frac":"17/20","book":"agrégateur cotes publiques","ai":55,"why":{"fr":"Malgré des stats offensives élevées sur 5 matchs (13 et 14 buts), les scores récents en Ligue des Champions ont été marqués par des victoires nettes mais peu de buts encaissés par Levski, et Craiova gagne souvent sur un score serré. Le modèle public price l'Under à 54.6% de probabilité. ⚠ Analyse en mode autonome (sources publiques), sans balayage oddschecker complet : cote indicative à revérifier chez ton bookmaker.","it":"Nonostante statistiche offensive elevate nelle ultime 5 gare (13 e 14 gol), i punteggi recenti in Champions League sono stati segnati da vittorie nette ma pochi gol subiti dal Levski, e il Craiova vince spesso con un punteggio stretto. Il modello pubblico stima l'Under al 54,6% di probabilità. ⚠ Analisi in modalità autonoma (fonti pubbliche), senza scansione completa oddschecker: quota indicativa da riverificare presso il tuo bookmaker."}},"markets":[{"category":{"fr":"Résultat & Double Chance","it":"Esito & Doppia Chance"},"note":{"fr":"Marché très équilibré selon plusieurs bookmakers publics.","it":"Mercato molto equilibrato secondo diversi bookmaker pubblici."},"rows":[{"sel":{"fr":"Levski Sofia","it":"Levski Sofia"},"dec":1.95,"frac":"19/20"},{"sel":{"fr":"Match nul","it":"Pareggio"},"dec":3.3,"frac":"23/10"},{"sel":{"fr":"Universitatea Craiova","it":"Universitatea Craiova"},"dec":3.8,"frac":"14/5"}]},{"category":{"fr":"Buts","it":"Gol"},"note":{"fr":"BTTS No proposé autour de 1.80-1.85 selon les previews publiques.","it":"BTTS No proposto intorno a 1,80-1,85 secondo le anteprime pubbliche."},"rows":[{"sel":{"fr":"BTTS Non","it":"BTTS No"},"dec":1.83,"frac":"5/6"},{"sel":{"fr":"Under 2.5 buts","it":"Under 2.5 gol"},"dec":1.85,"frac":"17/20"}]}],"valueBets":[{"label":{"fr":"Double chance 1X","it":"Doppia chance 1X"},"dec":1.35,"ai":74,"note":{"fr":"Sécurise la double probabilité la plus forte (victoire+nul) sur un duel très serré.","it":"Assicura la doppia probabilità più alta (vittoria+pareggio) in un duello molto equilibrato."}},{"label":{"fr":"BTTS Non","it":"BTTS No"},"dec":1.83,"ai":55,"note":{"fr":"Cohérent avec la solidité défensive récente de Levski et les victoires à l'écart serrées de Craiova.","it":"Coerente con la recente solidità difensiva del Levski e le vittorie in trasferta di misura del Craiova."}}],"prediction":{"pick":{"fr":"Levski Sofia gagne le match aller sur un score serré","it":"Il Levski Sofia vince la gara d'andata con un punteggio stretto"},"pickShort":"1 (Levski)","score":"2 - 1","goals":{"fr":"Under 2.5 buts favorisé par les modèles publics (54.6%).","it":"Under 2.5 gol favorito dai modelli pubblici (54,6%)."},"confidence":"moyen","value":true,"summary":{"fr":"Duel très équilibré entre deux équipes invaincues sur leurs dernières sorties. Levski profite de l'avantage du terrain et d'une dynamique domestique positive, mais Craiova reste dangereux en contre. ⚠ Analyse en mode autonome (sources publiques), sans balayage oddschecker complet : cote indicative à revérifier chez ton bookmaker.","it":"Duello molto equilibrato tra due squadre imbattute nelle ultime uscite. Il Levski sfrutta il fattore campo e una dinamica interna positiva, ma il Craiova resta pericoloso in ripartenza. ⚠ Analisi in modalità autonoma (fonti pubbliche), senza scansione completa oddschecker: quota indicativa da riverificare presso il tuo bookmaker."},"basedOn":{"fr":["Levski invaincu sur ses 2 derniers matchs (5 buts marqués, 1 encaissé)","Craiova également invaincu (5 buts marqués, 1 encaissé) sur la même période","Avantage du terrain et petit favoritisme du marché pour Levski"],"it":["Levski imbattuto nelle ultime 2 gare (5 gol segnati, 1 subito)","Anche il Craiova imbattuto (5 gol segnati, 1 subito) nello stesso periodo","Fattore campo e leggero favoritismo del mercato per il Levski"]},"against":{"fr":["Aucun historique H2H entre les deux clubs, incertitude accrue","Craiova affiche une forme excellente sur ses 5 derniers matchs (4V 1N)"],"it":["Nessun precedente H2H tra i due club, incertezza maggiore","Il Craiova mostra un'ottima forma nelle ultime 5 gare (4V 1N)"]}},"teams":{"home":{"name":{"fr":"Levski Sofia","it":"Levski Sofia"},"flag":"🔵","coach":"Julio Velázquez","lineup":{"fr":"Vutsov; Centelles, Vladimirov, Lukov; latéraux et milieu à confirmer; Perea en pointe soutenu par Bala.","it":"Vutsov; Centelles, Vladimirov, Lukov; laterali e centrocampo da confermare; Perea punta supportato da Bala."},"style":{"fr":"Bloc dominateur à domicile, forte possession (56.7%), pressing haut et jeu direct vers l'attaquant.","it":"Blocco dominante in casa, forte possesso (56,7%), pressing alto e gioco diretto verso l'attaccante."},"absences":{"fr":["Aucune absence majeure confirmée dans les sources consultées"],"it":["Nessuna assenza rilevante confermata nelle fonti consultate"]},"physical":{"fr":"Équipe fraîche, rythme de pré-saison + championnat déjà lancé.","it":"Squadra fresca, ritmo di pre-stagione + campionato già avviato."},"form":{"fr":"Levski a gagné 2-1 contre Dunav Ruse lors de son dernier match de championnat, et a éliminé Borac Banja Luka 4-0 à domicile au tour précédent de C1.","it":"Il Levski ha vinto 2-1 contro il Dunav Ruse nell'ultima gara di campionato e ha eliminato il Borac Banja Luka 4-0 in casa al turno precedente di Champions."},"xg":{"fr":"Données xG publiques non disponibles pour ce match précis.","it":"Dati xG pubblici non disponibili per questa gara specifica."},"context":{"fr":"Match aller du 2e tour de qualification, avec le retour prévu la semaine suivante.","it":"Gara d'andata del 2° turno di qualificazione, ritorno previsto la settimana successiva."},"source":"sportsgambler.com, futbol24.com"},"away":{"name":{"fr":"Universitatea Craiova","it":"Universitatea Craiova"},"flag":"🔴","coach":"Non communiqué dans les sources","lineup":{"fr":"Composition probable non détaillée dans les sources publiques consultées.","it":"Formazione probabile non dettagliata nelle fonti pubbliche consultate."},"style":{"fr":"Équipe portée sur l'attaque (16.2 tentatives/match en moyenne), victoires souvent obtenues sur un score court.","it":"Squadra orientata all'attacco (16,2 tentativi/partita in media), vittorie spesso ottenute con un punteggio stretto."},"absences":{"fr":["Aucune information précise trouvée sur des blessures ou suspensions"],"it":["Nessuna informazione precisa trovata su infortuni o squalifiche"]},"physical":{"fr":"Équipe en pleine forme, sur une série de victoires en championnat roumain.","it":"Squadra in gran forma, su una serie di vittorie nel campionato rumeno."},"form":{"fr":"Craiova a battu UTA Arad à domicile lors de son dernier match, et s'est imposé 1-0 face à ML Vitebsk au tour précédent de qualification.","it":"Il Craiova ha battuto l'UTA Arad in casa nell'ultima gara e si è imposto 1-0 contro il ML Vitebsk nel turno precedente di qualificazione."},"xg":{"fr":"Données xG publiques non disponibles pour ce match précis.","it":"Dati xG pubblici non disponibili per questa gara specifica."},"context":{"fr":"Craiova voyage en Bulgarie pour l'aller, avec l'ambition de préserver un résultat pour le retour à domicile.","it":"Il Craiova viaggia in Bulgaria per l'andata, con l'ambizione di preservare un risultato per il ritorno in casa."},"source":"sportsgambler.com"}},"keyPlayers":[{"team":"🔵","name":"Juan Perea","pos":{"fr":"Attaquant","it":"Attaccante"},"stat":{"fr":"Meilleur buteur de Levski avec 4 buts sur la période récente","it":"Miglior marcatore del Levski con 4 gol nel periodo recente"},"note":{"fr":"Référence offensive du Levski, danger constant en profondeur.","it":"Riferimento offensivo del Levski, pericolo costante in profondità."}},{"team":"🔵","name":"Everton Bala","pos":{"fr":"Milieu offensif / Ailier","it":"Centrocampista offensivo / Ala"},"stat":{"fr":"Meilleur passeur de l'équipe avec 5 assists","it":"Miglior assist-man della squadra con 5 assist"},"note":{"fr":"Créateur principal du jeu offensif de Levski.","it":"Principale creatore del gioco offensivo del Levski."}}],"matchInfo":{"h2h":{"fr":"Aucune confrontation officielle connue entre les deux clubs avant ce match.","it":"Nessun precedente ufficiale noto tra i due club prima di questa gara."},"referee":{"fr":"Adam Ladebäck (Suède)","it":"Adam Ladebäck (Svezia)"},"stake":{"fr":"Match aller du 2e tour de qualification C1 2026/27, qualification sur les deux manches.","it":"Gara d'andata del 2° turno di qualificazione Champions 2026/27, qualificazione sul doppio confronto."},"external":{"fr":"Retour prévu la semaine suivante à Craiova.","it":"Ritorno previsto la settimana successiva a Craiova."},"supercomputer":{"fr":"Les modèles publics (Sportsmole, Wincomparator) donnent Levski favori entre 43% et 47%, un nul entre 24% et 36%, et Craiova entre 20% et 28%.","it":"I modelli pubblici (Sportsmole, Wincomparator) danno il Levski favorito tra il 43% e il 47%, un pareggio tra il 24% e il 36%, e il Craiova tra il 20% e il 28%."}},"sources":[{"label":"Sportsgambler – Levski vs Craiova preview","url":"https://www.sportsgambler.com/betting-tips/football/levski-sofia-vs-universitatea-craiova-prediction-lineups-odds-2026-07-22/"},{"label":"Oddslot – Levski vs Craiova odds","url":"https://oddslot.com/football/match/uefa-champions-league/levski-sofia/universitatea-craiova/22-jul-2026/"},{"label":"OneFootball – Levski vs Craiova model","url":"https://onefootball.com/en/news/levski-sofia-vs-universitatea-craiova-prediction-champions-league-qualifier-preview-43163651"},{"label":"Futbol24 – betting tip","url":"https://www.futbol24.com/betting-tips/preview/22-07-2026-levski-sofia-cs-universitatea-craiova-betting-tip/"},{"label":"Betshoot – preview","url":"https://www.betshoot.com/football/19721263-Levski-Sofia-vs-Universitatea-Craiova-prediction/"}]},
...
/* =========================================================
   ...
   ========================================================= */
const TICKETS = [
{"title":{"fr":"⭐ Meilleur combiné du jour — 2026-07-24","it":"⭐ Miglior combinata del giorno — 24-07-2026"},"totalOdds":2.63,"rating":8,"would":true,"legs":[{"fr":"Västerås SK Over 1,5 but (équipe) · cote 1.50 · proba estimée 74% · valeur +11%","it":"Västerås SK Over 1,5 gol (squadra) · quota 1.50 · probabilità stimata 74% · valore +11%"},{"fr":"Victoire Djurgårdens IF · cote 1.75 · proba estimée 60% · valeur +5%","it":"Vittoria Djurgårdens IF · quota 1.75 · probabilità stimata 60% · valore +5%"}],"verdict":{"fr":"Logique du combiné : deux équipes en net regain de forme offensive (Västerås à domicile face à un Örgryte très friable, et Djurgården en pleine bourrasque positive face à un Degerfors diminué) sont associées pour viser une cote totale proche de 2,63. Le maillon le plus fragile reste Degerfors qui, jouant à domicile pour son maintien, pourrait accrocher un nul surprise. Calcul : cote totale ≈ 1.50 × 1.75 = 2.63 ; probabilité combinée ≈ 0.74 × 0.60 = 44.4% ; espérance ≈ 0.444 × 2.63 − 1 ≈ +16.7%. Mise suggérée : 3-4 € sur une bankroll de 25 €. ⚠ Analyse en mode autonome (sources publiques), sans balayage oddschecker complet : cotes indicatives à revérifier chez ton bookmaker avant de miser. Ceci est une aide à la décision, pas un conseil financier. Jeu responsable, 18+.","it":"Logica della combinata: due squadre in netta ripresa offensiva (Västerås in casa contro un Örgryte molto fragile, e Djurgården in piena serie positiva contro un Degerfors indebolito) sono associate per puntare a una quota totale vicina a 2,63. L'anello più fragile resta il Degerfors che, giocando in casa per la salvezza, potrebbe agganciare un pareggio a sorpresa. Calcolo: quota totale ≈ 1.50 × 1.75 = 2.63; probabilità combinata ≈ 0.74 × 0.60 = 44.4%; valore atteso ≈ 0.444 × 2.63 − 1 ≈ +16.7%. Puntata suggerita: 3-4 € su un bankroll di 25 €. ⚠ Analisi in modalità autonoma (fonti pubbliche), senza scansione completa di oddschecker: quote indicative da riverificare presso il tuo bookmaker prima di puntare. Questo è un aiuto alla decisione, non una consulenza finanziaria. Gioco responsabile, 18+."}},

{"title":{"fr":"⭐ Meilleur combiné du jour — 2026-07-23","it":"⭐ Miglior combinata del giorno — 23-07-2026"},"totalOdds":2.08,"rating":5.9,"would":true,"legs":[{"fr":"Hammarby – Double chance 1X · cote 1,60 · proba estimée 63% · valeur ≈ +1%","it":"Hammarby – Doppia chance 1X · quota 1,60 · probabilità stimata 63% · valore ≈ +1%"},{"fr":"CFR Cluj – Double chance X2 · cote 1,30 · proba estimée 80% · valeur ≈ +4%","it":"CFR Cluj – Doppia chance X2 · quota 1,30 · probabilità stimata 80% · valore ≈ +4%"}],"verdict":{"fr":"Logique du combiné : miser sur la dynamique offensive et le facteur domicile d'Hammarby (1X face à un Anderlecht sans rythme) associée à la supériorité d'expérience européenne de CFR Cluj (X2 face à un Alashkert modeste). Le maillon fragile reste Hammarby, qui aborde ce match sous un tout nouveau coach et sans H2H de référence face à Anderlecht. Cote totale ≈ 2,08, probabilité combinée ≈ 50,4%, espérance de gain ≈ +4,8%. Mise suggérée : 3 à 4 € sur une base de 25 €, à ajuster selon ta bankroll. ⚠ Analyse en mode autonome (sources publiques), sans balayage oddschecker complet : cote indicative à revérifier chez ton bookmaker. Pari réservé aux 18+, joue de façon responsable.","it":"Logica della combo: puntare sulla dinamica offensiva e sul fattore campo dell'Hammarby (1X contro un Anderlecht senza ritmo) unita alla superiorità di esperienza europea del CFR Cluj (X2 contro un Alashkert modesto). L'anello debole resta l'Hammarby, che affronta la gara con un allenatore appena arrivato e senza precedenti H2H contro l'Anderlecht. Quota totale ≈ 2,08, probabilità combinata ≈ 50,4%, valore atteso ≈ +4,8%. Puntata suggerita: 3-4 € su una base di 25 €, da adattare al proprio bankroll. ⚠ Analisi in modalità autonoma (fonti pubbliche), senza scansione completa oddschecker: quota indicativa da riverificare presso il tuo bookmaker. Scommessa riservata ai maggiori di 18 anni, gioca in modo responsabile."}},

{"title":{"fr":"⭐ Meilleur combiné du jour — 2026-07-22","it":"⭐ Miglior combo del giorno — 22-07-2026"},"totalOdds":2.48,"rating":6.1,"would":true,"legs":[{"fr":"Omonia Nicosie – Plus de 1.5 but · cote 1.34 · proba estimée 78% · valeur +4%","it":"Omonia Nicosia – Over 1.5 gol · quota 1,34 · probabilità stimata 78% · valore +4%"},{"fr":"Levski Sofia – Moins de 2.5 buts · cote 1.85 · proba estimée 55% · valeur +2%","it":"Levski Sofia – Under 2.5 gol · quota 1,85 · probabilità stimata 55% · valore +2%"}],"verdict":{"fr":"Logique du combiné : on associe le pari le plus solide du match Omonia-Kairat (Over 1.5 but, très probable vu les statistiques offensives des deux équipes) avec le pari value du match Levski-Craiova (Under 2.5, appuyé par la solidité défensive récente de Levski et les victoires courtes de Craiova). Cote totale visée : 2.48. Probabilité combinée estimée : environ 42.9% (0.78 × 0.55). Espérance : (0.429 × 2.48) − 1 ≈ +6.3%, un edge positif mais modeste. Maillon fragile : l'Under 2.5 à Sofia, car les deux équipes ont un profil offensif marqué sur la période récente malgré des scores courts. Mise suggérée : 3-4 € sur une bankroll de 25 €, pour limiter le risque. ⚠ Analyse en mode autonome (sources publiques), sans balayage oddschecker complet : cote indicative à revérifier chez ton bookmaker. Ceci est une aide à la décision, pas un conseil financier — jeu responsable, 18+.","it":"Logica del combo: si associa la scommessa più solida della gara Omonia-Kairat (Over 1.5 gol, molto probabile viste le statistiche offensive di entrambe le squadre) con la scommessa di valore della gara Levski-Craiova (Under 2.5, sostenuta dalla recente solidità difensiva del Levski e dalle vittorie di misura del Craiova). Quota totale target: 2,48. Probabilità combinata stimata: circa 42,9% (0,78 × 0,55). Valore atteso: (0,429 × 2,48) − 1 ≈ +6,3%, un edge positivo ma modesto. Anello debole: l'Under 2.5 a Sofia, poiché entrambe le squadre hanno un profilo offensivo marcato nel periodo recente nonostante punteggi corti. Puntata suggerita: 3-4 € su un bankroll di 25 €, per limitare il rischio. ⚠ Analisi in modalità autonoma (fonti pubbliche), senza scansione completa oddschecker: quota indicativa da riverificare presso il tuo bookmaker. Questo è un aiuto alla decisione, non un consiglio finanziario — gioco responsabile, 18+."}},
  ...
  },
  {
    ...
    legs: [
      ...
      { fr: "Les deux équipes marquent — Oui (FC Thun v Dinamo Zagreb) — 1.51 · proba estimée 67% · valeur +1,2%", it: "Entrambe segnano — Sì (FC Thun v Dinamo Zagabria) — 1.51 · prob. stimata 67% · valore +1,2%" },
    ...
    verdict: {
      fr: "Probabilité combinée estimée : 32,8% → cote juste 3,05 contre 3,15 proposés, soit une espérance de +3,2%. Note 5,6/10 : c est le premier combiné soumis dont l espérance est mathématiquement favorable, et je le jouerais. POURQUOI ÇA MARCHE : trois sélections seulement, et aucune sur un favori court. Chaque jambe ajoutée à un combiné empile la marge du bookmaker — trois marchés secondaires bien choisis battent quatre favoris à 1.20. THUN–DINAMO BTTS (+1,2%) : Thun est monté de D2 en 2025 et a remporté son premier titre suisse en plus de 120 ans avec 80 buts marqués mais 52 encaissés en 38 journées, soit 2,11 marqués et 1,37 encaissés par match. Nouvel entraîneur, plusieurs cadres partis et possiblement deux défenseurs centraux absents. Les deux équipes ont marqué lors des 6 derniers matchs de Thun. En face, Dinamo Zagreb reste sur 22 matchs sans défaite et 16 buts en 4 amicaux. IBERIA–SLOVAN BTTS (+3,9%) : la meilleure valeur du ticket — Iberia a marqué 3 puis 2 buts en qualifications et encaisse 2 buts par match, Slovan a marqué dans 4 de ses 5 amicaux. KLAKSVÍK 1-3 (73%) : la jambe la plus fiable — 7 matchs sans défaite, pelouse synthétique inconnue de l adversaire, Kauno Žalgiris avec 3 jours de récupération seulement. LE RISQUE PRINCIPAL : ce sont trois matchs aller. Si Dinamo prend deux buts d avance et referme le match, Thun peut rester à zéro — le consensus des analystes penche d ailleurs pour un under 2.5 sur cette rencontre. MISE SUGGÉRÉE : 3 à 4 € sur un bankroll de 25 €. Un avantage de +3,2% reste mince : ce ticket sera perdu environ 2 fois sur 3, c est normal et attendu. C est la répétition sur des dizaines de paris qui paie, pas celui-ci.",
      it: "Probabilità combinata stimata: 32,8% → quota equa 3,05 contro i 3,15 offerti, cioè un aspettativa di +3,2%. Voto 5,6/10: è la prima multipla sottopostami la cui aspettativa è matematicamente favorevole, e la giocherei. PERCHÉ FUNZIONA: solo tre selezioni, e nessuna su un favorito corto. Ogni tratta aggiunta a una multipla accumula il margine del bookmaker — tre mercati secondari ben scelti battono quattro favoriti a 1.20. THUN–DINAMO BTTS (+1,2%): il Thun è salito dalla seconda divisione nel 2025 e ha vinto il primo titolo svizzero in oltre 120 anni con 80 gol fatti ma 52 subiti in 38 giornate, cioè 2,11 fatti e 1,37 subiti a partita. Nuovo allenatore, diversi titolari partiti e forse due difensori centrali assenti. Entrambe le squadre hanno segnato nelle ultime 6 gare del Thun. Di fronte, la Dinamo Zagabria è imbattuta da 22 partite con 16 gol in 4 amichevoli. IBERIA–SLOVAN BTTS (+3,9%): il miglior valore del ticket — l Iberia ha segnato 3 e poi 2 gol in qualificazione e ne subisce 2 a partita, lo Slovan ha segnato in 4 delle 5 amichevoli. KLAKSVÍK 1-3 (73%): la tratta più affidabile — 7 gare senza sconfitte, campo sintetico sconosciuto all avversario, Kauno Žalgiris con soli 3 giorni di recupero. IL RISCHIO PRINCIPALE: sono tre gare di andata. Se la Dinamo va sul doppio vantaggio e chiude la partita, il Thun può restare a zero — il consenso degli analisti propende peraltro per un under 2.5 su questa gara. PUNTATA SUGGERITA: 3-4 € su un bankroll di 25 €. Un vantaggio del +3,2% resta sottile: questo ticket sarà perso circa 2 volte su 3, è normale e atteso. È la ripetizione su decine di scommesse che paga, non questa."
    }
  },
  {
    title: { fr: "Quadruple bet365 (5 €) — quatre favoris courts — 21 juillet 2026", it: "Quadrupla bet365 (5 €) — quattro favoriti corti — 21 luglio 2026" },
    totalOdds: 3.18,
    rating: 2.0,
    would: false,
    legs: [
      { fr: "Dinamo Zagreb — remboursé si match nul (FC Thun v Dinamo Zagreb) — 1.40 · proba estimée 65,8% · valeur −7,9%", it: "Dinamo Zagabria — rimborso in caso di pareggio (FC Thun v Dinamo Zagabria) — 1.40 · prob. stimata 65,8% · valore −7,9%" },
      { fr: "Fenerbahçe gagne (Fenerbahçe v Górnik Zabrze) — 1.18 · proba estimée 81% · valeur −4,4%", it: "Vittoria Fenerbahçe (Fenerbahçe v Górnik Zabrze) — 1.18 · prob. stimata 81% · valore −4,4%" },
      { fr: "Crvena Zvezda plus de 1,5 but (Larne v Crvena Zvezda) — 1.30 · proba estimée 72% · valeur −6,4%", it: "Stella Rossa più di 1,5 gol (Larne v Stella Rossa) — 1.30 · prob. stimata 72% · valore −6,4%" },
      { fr: "Győri ETO gagne (Atert Bissen v Győri ETO) — 1.48 · proba estimée 62% · valeur −8,2%", it: "Vittoria Győri ETO (Atert Bissen v Győri ETO) — 1.48 · prob. stimata 62% · valore −8,2%" }
    ],
    verdict: {
      fr: "Probabilité combinée estimée : 23,8% → cote juste 4,20 contre 3,18 proposés, soit une espérance de −24%. Note 2/10 : je ne le jouerais pas. LE PROBLÈME N EST PAS UNE SÉLECTION, C EST L EMPILEMENT. Aucune des quatre jambes n est absurde prise isolément, mais chacune coûte entre 4% et 8% de marge, et ces marges se multiplient : 0,921 × 0,956 × 0,936 × 0,918 = 0,76. Un quart de la mise est perdu avant même le coup d envoi. C est le piège classique du combiné : on croit sécuriser en ajoutant des favoris, on ne fait qu ajouter de la taxe. DÉTAIL DES JAMBES. Dinamo DNB à 1.40 : le 1N2 du marché (Thun 3.75 / nul 3.80 / Dinamo 1.95) donne, marge retirée, Dinamo 49,2% et nul 25,2%, donc un DNB à 65,8% contre 71,4% impliqués — le filet de sécurité est vendu bien au-dessus de sa valeur, et Thun n est pas un faire-valoir avec ses 80 buts en 38 journées. Fenerbahçe à 1.18 : la moins mauvaise, quasiment au prix du marché (1/6), Fener n étant privé que de Kanté face à un Górnik sans son gardien titulaire Łoska (suspendu) ni Kubicki (bras fracturé). Crvena Zvezda plus de 1,5 but à 1.30 : Zvezda va gagner (coté 1.18, 9e titre serbe d affilée, 5-0 sur Mačva en préparation) mais marquer 2 buts sur pelouse synthétique à Inver Park dans un match aller gérable est loin d être acquis — le score le plus probable du marché est 0-2 à la cote 6.00. Győri ETO à 1.48 : le marché donne Győr à seulement 45,7% de victoire et le MEILLEUR PRIX DISPONIBLE EST 1.57 chez Unibet — sur cette seule sélection, 6% de valeur sont perdus faute de comparer les bookmakers. LE CASH OUT : bet365 proposait 5,00 € de sortie pour 5,00 € misés, alors que l espérance de conservation est de 0,238 × 15,90 = 3,79 €. Récupérer 100% de sa mise sur un ticket qui en vaut 3,79 € représente un gain de +24% — une sortie à 100% avant coup d envoi est rare et c était le meilleur coup disponible. La décision reste entièrement personnelle et ces valeurs bougent en continu.",
      it: "Probabilità combinata stimata: 23,8% → quota equa 4,20 contro i 3,18 offerti, cioè un aspettativa del −24%. Voto 2/10: non la giocherei. IL PROBLEMA NON È UNA SELEZIONE, È L ACCUMULO. Nessuna delle quattro tratte è assurda presa da sola, ma ognuna costa tra il 4% e l 8% di margine, e questi margini si moltiplicano: 0,921 × 0,956 × 0,936 × 0,918 = 0,76. Un quarto della puntata è perso ancor prima del fischio d inizio. È la trappola classica della multipla: si crede di mettersi al sicuro aggiungendo favoriti, si aggiunge solo tassa. DETTAGLIO DELLE TRATTE. Dinamo DNB a 1.40: l 1X2 del mercato (Thun 3.75 / pari 3.80 / Dinamo 1.95) dà, tolto il margine, Dinamo 49,2% e pari 25,2%, quindi un DNB al 65,8% contro il 71,4% implicito — la rete di sicurezza è venduta ben sopra il suo valore, e il Thun non è una comparsa con i suoi 80 gol in 38 giornate. Fenerbahçe a 1.18: la meno peggio, quasi al prezzo di mercato (1/6), col Fener privo del solo Kanté contro un Górnik senza il portiere titolare Łoska (squalificato) né Kubicki (braccio fratturato). Stella Rossa più di 1,5 gol a 1.30: la Stella Rossa vincerà (quotata 1.18, nono titolo serbo di fila, 5-0 al Mačva in preparazione) ma segnare 2 gol su sintetico a Inver Park in una gara di andata gestibile è tutt altro che scontato — il risultato più probabile secondo il mercato è 0-2 a quota 6.00. Győri ETO a 1.48: il mercato dà il Győr solo al 45,7% di vittoria e il MIGLIOR PREZZO DISPONIBILE È 1.57 su Unibet — su questa sola selezione si perde il 6% di valore per non aver confrontato i bookmaker. IL CASH OUT: bet365 offriva 5,00 € di uscita per 5,00 € puntati, mentre l aspettativa mantenendo il ticket è 0,238 × 15,90 = 3,79 €. Recuperare il 100% della puntata su un ticket che ne vale 3,79 € rappresenta un guadagno del +24% — un uscita al 100% prima del fischio d inizio è rara ed era la mossa migliore disponibile. La decisione resta del tutto personale e questi valori cambiano di continuo."
    }
  },
  {
    title: { fr: "Triple qualifications LDC — 21 juillet 2026 (corrigé)", it: "Tripla qualificazioni Champions — 21 luglio 2026 (corretto)" },
    totalOdds: 2.82,
    rating: 5.8,
    would: true,
    legs: [
      { fr: "Fenerbahçe 2-5 buts (Fenerbahçe v Górnik Zabrze) — 1.35 · proba estimée 75,5% · valeur +1,9% (corrigé)", it: "Fenerbahçe 2-5 gol (Fenerbahçe v Górnik Zabrze) — 1.35 · prob. stimata 75,5% · valore +1,9% (corretto)" },
      { fr: "Klaksvík 1-3 buts (KÍ Klaksvík v Kauno Žalgiris) — 1.35 · proba estimée 73% · valeur −1,5%", it: "Klaksvík 1-3 gol (KÍ Klaksvík v Kauno Žalgiris) — 1.35 · prob. stimata 73% · valore −1,5%" },
      { fr: "Les deux équipes marquent — Oui (Iberia 1999 v Slovan Bratislava) — 1.55 · proba estimée 67% · valeur +3,9%", it: "Entrambe segnano — Sì (Iberia 1999 v Slovan Bratislava) — 1.55 · prob. stimata 67% · valore +3,9%" }
    ],
    verdict: {
      fr: "⚠ CORRECTION DU 21/07/2026 — une première version de cette fiche notait ce ticket 4,5/10 avec une espérance de −3,4%, au motif que Fenerbahçe serait privé de Vedat Muriqi, Dorgelès Nene, N Golo Kanté et Mert Hakan Yandaş. Les informations d équipe confirmées contredisent cette liste : le seul absent de Fenerbahçe est N Golo Kanté, et le onze probable est au complet (Günok ; Müldür, Škriniar, Oosterwolde, Mercan ; Guendouzi, Fred ; Kahveci, Asensio, Aktürkoğlu ; Talisca). C est Górnik qui est amputé, avec son gardien titulaire Tomasz Łoska suspendu et Jarosław Kubicki absent environ deux mois après une fracture du bras subie contre Lech Poznań le 16 juillet. Fenerbahçe reste par ailleurs sur trois victoires en trois amicaux de juillet — 5-0 Admira, 4-0 Pogoń Szczecin, 2-1 LASK — soit 11 buts marqués pour 1 encaissé. CHIFFRES CORRIGÉS : Fenerbahçe 2-5 buts vaut environ 75,5% de probabilité, soit +1,9% de valeur et non −5,5%. La probabilité combinée passe de 34,2% à 36,9%, la cote juste à 2,71 contre 2,82 proposés, et l espérance devient POSITIVE à +4,2%. Note révisée : 5,8/10, et je le jouerais. MEILLEURE JAMBE EN VALEUR : les deux équipes marquent sur Iberia–Slovan (+3,9%) — Iberia a marqué 3 puis 2 buts en qualifications et encaisse 2 buts par match, Slovan a marqué dans 4 de ses 5 amicaux. JAMBE LA PLUS FIABLE : Klaksvík 1-3 (73%), 7 matchs sans défaite, pelouse synthétique inconnue de l adversaire, Kauno Žalgiris avec 3 jours de récupération seulement et 1 victoire sur ses 5 derniers matchs. RISQUE RÉSIDUEL : Fenerbahçe exige toujours 2 buts, et une gestion tranquille à 1-0 en match aller ferait tomber le ticket. MISE SUGGÉRÉE : 3 à 4 € sur 25 €.",
      it: "⚠ CORREZIONE DEL 21/07/2026 — una prima versione di questa scheda valutava il ticket 4,5/10 con un aspettativa del −3,4%, sostenendo che il Fenerbahçe fosse privo di Vedat Muriqi, Dorgelès Nene, N Golo Kanté e Mert Hakan Yandaş. Le informazioni confermate sulle formazioni smentiscono questo elenco: l unico assente del Fenerbahçe è N Golo Kanté, e l undici probabile è al completo (Günok; Müldür, Škriniar, Oosterwolde, Mercan; Guendouzi, Fred; Kahveci, Asensio, Aktürkoğlu; Talisca). È il Górnik a essere menomato, col portiere titolare Tomasz Łoska squalificato e Jarosław Kubicki fuori circa due mesi dopo la frattura al braccio rimediata contro il Lech Poznań il 16 luglio. Il Fenerbahçe arriva inoltre da tre vittorie in tre amichevoli di luglio — 5-0 Admira, 4-0 Pogoń Szczecin, 2-1 LASK — cioè 11 gol fatti e 1 subito. NUMERI CORRETTI: Fenerbahçe 2-5 gol vale circa il 75,5% di probabilità, quindi +1,9% di valore e non −5,5%. La probabilità combinata passa dal 34,2% al 36,9%, la quota equa a 2,71 contro i 2,82 offerti, e l aspettativa diventa POSITIVA a +4,2%. Voto rivisto: 5,8/10, e la giocherei. MIGLIOR TRATTA PER VALORE: entrambe segnano su Iberia–Slovan (+3,9%) — l Iberia ha segnato 3 e poi 2 gol in qualificazione e ne subisce 2 a partita, lo Slovan ha segnato in 4 delle 5 amichevoli. TRATTA PIÙ AFFIDABILE: Klaksvík 1-3 (73%), 7 gare senza sconfitte, campo sintetico sconosciuto all avversario, Kauno Žalgiris con soli 3 giorni di recupero e 1 vittoria nelle ultime 5. RISCHIO RESIDUO: il Fenerbahçe deve comunque segnare 2 gol, e una gestione tranquilla sull 1-0 all andata farebbe cadere il ticket. PUNTATA SUGGERITA: 3-4 € su 25 €."
    }
  }
];
