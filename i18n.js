...
const DICT = {
  fr: {
    ...
    search_ph: "🔍 Rechercher une équipe, une compétition…",
    filter_all: "Tous",
    matches_word: "match(s)",
    no_results: "Aucun match ne correspond à ta recherche.",
  ...
  it: {
    ...
    search_ph: "🔍 Cerca una squadra, una competizione…",
    filter_all: "Tutte",
    matches_word: "partita/e",
    no_results: "Nessuna partita corrisponde alla tua ricerca.",
